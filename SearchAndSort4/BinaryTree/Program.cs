...
namespace BinaryTree
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Record q = new Record(37, pos, len, "Внешность_Ноора");
            //q.Beam = null;
            q.Left = null;
            q.Right = null;
            /*MakeRef(11, out pos, out len);
            q.AddRay(new Record(11, pos, len, "Внешность_Низы"));
            MakeRef(25, out pos, out len);
            q.AddRay(new Record(25, pos, len, "Эрг_Ноор"));
            MakeRef(37, out pos, out len);
            ...
            Algorithm_D.BinaryTree bt = new Algorithm_D.BinaryTree();
            bt.Root = q;
            bf.Serialize(fs, bt);
            fs.Close();
